	...
	return function() {
		...
		1: [function(require, module, exports) {
			...
			var toGCJ02 = exports.toGCJ02 = forEachPoint(function(input, output, offset) {
				var x = input[offset] - .0065;
				var y = input[offset + 1] - .006;
			...
			var fromGCJ02 = exports.fromGCJ02 = forEachPoint(function(input, output, offset) {
				...
				var z = Math.sqrt(x * x + y * y) + 2e-5 * Math.sin(y * X_PI);
				var theta = Math.atan2(y, x) + 3e-6 * Math.cos(x * X_PI);
				output[offset] = z * Math.cos(theta) + .0065;
				output[offset + 1] = z * Math.sin(theta) + .006;
				return output
			});
		...
		2: [function(require, module, exports) {
			...
			function transformLat(x, y) {
				var ret = -100 + 2 * x + 3 * y + .2 * y * y + .1 * x * y + .2 * Math.sqrt(Math.abs(x));
			...
			function transformLon(x, y) {
				var ret = 300 + x + 2 * y + .1 * x * x + .1 * x * y + .1 * Math.sqrt(Math.abs(x));
				ret += (20 * Math.sin(6 * x * PI) + 20 * Math.sin(2 * x * PI)) * 2 / 3;
		...
		5: [function(require, module, exports) {
			...
			function convertor(input, output, offset, table) {
				...
				var y = table[2] + table[3] * d + table[4] * d * d + table[5] * d * d * d + table[6] * d * d * d * d + table[7] *
					d * d * d * d * d + table[8] * d * d * d * d * d * d;
